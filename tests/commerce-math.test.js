...
test('BRIONE conserva compra y caducidad sin presentar una clase AC contradictoria como confirmada', () => {
  const p = catalog.floor.find(p => p.id === 'loc-ac5');
  assert.ok(!p.name.includes('AC5'));
